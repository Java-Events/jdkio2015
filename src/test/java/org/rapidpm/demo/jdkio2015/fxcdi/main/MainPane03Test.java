package org.rapidpm.demo.jdkio2015.fxcdi.main;
...
public class MainPane03Test extends CDIGuiTest {
  ...
  public void testMainPane03() throws Exception {
    ...
    Assertions.verifyThat(editPaneLabel, hasText("BusinessLogicImpl BusinessSubLogicImpl used 0"));

    clickOn(btnMain);
    Assertions.verifyThat(btnMain, hasText("Main pressed 1"));
    Assertions.verifyThat(editPaneLabel, hasText("BusinessLogicImpl BusinessSubLogicImpl used 1"));
  }
}
